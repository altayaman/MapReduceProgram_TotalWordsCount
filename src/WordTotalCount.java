...
//	    		word.set(itr.nextToken());    // set word as each input keyword
	    		context.write(new Text("Total words:"), one);     // create a pair <keyword, 1> 
	    	}
	    }
	}
    ...
    job.setJarByClass(WordTotalCount.class);
